...
class LanceViewController: UIViewController {
...
extension LanceViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    //search bar
extension LanceViewController: UISearchBarDelegate {
