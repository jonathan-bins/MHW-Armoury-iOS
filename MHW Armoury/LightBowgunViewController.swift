//
//  LightBowgunViewController.swift
//  MHW Armoury
//
...
class LightBowgunViewController: UIViewController {
...
extension LightBowgunViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    //search bar
extension LightBowgunViewController: UISearchBarDelegate {
