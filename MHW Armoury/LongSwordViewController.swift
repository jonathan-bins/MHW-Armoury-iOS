...
class LongSwordViewController: UIViewController {
...
extension LongSwordViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    //search bar
extension LongSwordViewController: UISearchBarDelegate {
