//
//  HuntingHornViewController.swift
//  MHW Armoury
//
...
class HuntingHornViewController: UIViewController {
...
extension HuntingHornViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    //search bar
extension HuntingHornViewController: UISearchBarDelegate {
