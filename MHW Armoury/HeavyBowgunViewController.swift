//
//  HeavyBowgunViewController.swift
//  MHW Armoury
//
...
class HeavyBowgunViewController: UIViewController {
...
extension HeavyBowgunViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    //search bar
extension HeavyBowgunViewController: UISearchBarDelegate {
