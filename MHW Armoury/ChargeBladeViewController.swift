//
//  ChargeBladeViewController.swift
//  MHW Armoury
//
...
class ChargeBladeViewController: UIViewController {
...
extension ChargeBladeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    //search bar
extension ChargeBladeViewController: UISearchBarDelegate {
