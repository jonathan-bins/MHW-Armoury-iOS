...
class SwitchAxeViewController: UIViewController {
...
extension SwitchAxeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    //search bar
extension SwitchAxeViewController: UISearchBarDelegate {
