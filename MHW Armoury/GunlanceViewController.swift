...
class GunlanceViewController: UIViewController {
...
extension GunlanceViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    //search bar
extension GunlanceViewController: UISearchBarDelegate {
