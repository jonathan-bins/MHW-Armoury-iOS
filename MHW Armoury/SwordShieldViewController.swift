//
//  SwordShieldViewController.swift
//  MHW Armoury
//
...
class SwordShieldViewController: UIViewController {
...
extension SwordShieldViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    //search bar
extension SwordShieldViewController: UISearchBarDelegate {
